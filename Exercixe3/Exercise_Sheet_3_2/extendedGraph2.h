...
#ifndef EXERCISE_SHEET_3_2_EXTENDEDGRAPH2_H
#define EXERCISE_SHEET_3_2_EXTENDEDGRAPH2_H
...
public:
    ...
    //NEW Spannbaum für den uebergebenen Vertex

    void depthFirstSearch(std::string vertex);
    void tiefenSuche(int n, bool gesehen[]);

};

#endif //EXERCISE_SHEET_3_2_EXTENDEDGRAPH2_H
